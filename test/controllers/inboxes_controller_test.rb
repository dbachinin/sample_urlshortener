...
class InboxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inbox" do
    assert_difference('Inbox.count') do
      post inboxes_url, params: { inbox: { read: @inbox.read, reseiver: @inbox.reseiver, sender: @inbox.sender, shortmessage: @inbox.shortmessage } }
    end
  ...
  test "should update inbox" do
    patch inbox_url(@inbox), params: { inbox: { read: @inbox.read, reseiver: @inbox.reseiver, sender: @inbox.sender, shortmessage: @inbox.shortmessage } }
